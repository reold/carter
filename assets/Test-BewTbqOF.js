import{ai as K,C as E,u as L,aj as I,h as r,af as R,ak as V,al as W,I as $,am as B,w as D,a as h,z as G,t as w,s as f,an as m,c as g,b as v,ao as k}from"./index-SLKQ29u1.js";import{i as x}from"./if-DMOYE36o.js";import{b as P}from"./input-TzdR0D5G.js";function H(p=!1){const s=R,t=s.l.u;if(!t)return;let i=()=>W(s.s);if(p){let l=0,a={};const _=$(()=>{let y=!1;const u=s.s;for(const d in u)u[d]!==a[d]&&(a[d]=u[d],y=!0);return y&&l++,l});i=()=>r(_)}t.b.length&&K(()=>{O(s,i),I(t.b)}),E(()=>{const l=L(()=>t.m.map(V));return()=>{for(const a of l)typeof a=="function"&&a()}}),t.a.length&&E(()=>{O(s,i),I(t.a)})}function O(p,s){if(p.l.s)for(const t of p.l.s)r(t);s()}B();var J=w(`<div class="relative"><input type="email" id="email" required placeholder=" " class="peer w-full px-4 py-2 border border-gray-300 dark:border-gray-600
