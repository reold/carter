...
{#await route.component()}
  <div
    class="h-[100dvh] flex flex-col items-center justify-center px-[2.5dvw] text-white animate-pulse"
    transition:fade={{ duration: 150, delay: 100 }}
  >
    <CarterLogo class="h-[30dvh] w-[30dvh] ring-1 ring-white rounded-full" />
    <h1 class="text-2xl font-medium text-center mt-2">
      <svg
    ...
    <p class="text-zinc-500 mt-5 text-center text-sm max-w-[75%]">
